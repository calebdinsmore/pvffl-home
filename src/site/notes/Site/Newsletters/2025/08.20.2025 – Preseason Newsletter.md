---
{"dg-publish":true,"dg-path":"Newsletters/2025/08.20.2025 – Preseason Newsletter.md","permalink":"/newsletters/2025/08-20-2025-preseason-newsletter/"}
---
...
<mark class="yellow">2025 PVFFL Grand Champion</mark>

![ChampTrophy128.png](/img/user/z_Assets/img/ChampTrophy128.png)
<mark class="yellow">2024 PVFFL Grand Champion</mark>

![LeagueChamp64.png](/img/user/z_Assets/img/LeagueChamp64.png)
<mark class="yellow mark-border">2025 Prairie View North Champion</mark>
...
| ------------------------- | ---------------------- | ------------------ | ------------------------------------ | -------------- |
| Prairie View North (2025) | 7-7                    | #1 Champion        | 84-42                                | 1932.2         |
...
|                                                | **Stat** | **Rank** |
| ---------------------------------------------- | -------- | -------- |
| **Regular Season Win / Loss**                  | 22-34 | #21 |
| **Playoff Appearances**                        | 2 | #5 |
| **Playoff Win / Loss**                         | 6-0 | #1 |
| **Regular Season [[Site/Glossary/Absolute Win-Loss (AWL)\|Absolute Win-Loss (AWL)]]** | 270-234 | #4 |
| **Regular Season Win %**                       | 39.3% | #21 |
| **Playoff Win %**                              | 100.0% | #1 |
| **Regular Season Absolute Win %**              | 53.6% | #10 |
| **Regular Season Points-For**                  | 6796.1 | #2 |
| **Luck**                                       | -14.3% | #26 |
...
I've written scripts to pull down all the Sleeper data the platform makes available and use it to make these tables. Here you can see with definitive proof that [[Site/Teams/@BenH 🏆 (Marshmallow Fluff)\|@BenH 🏆 (Marshmallow Fluff)]] is **THE** unluckiest owner in PVFFL history (in the Sleeper era). And on [[Site/Teams/@LoriH (Hurts Donut)\|@LoriH (Hurts Donut)]]'s page you can see that she's arguably the best owner to never secure a <mark class="yellow">Grand Champion</mark> title, being the only owner in the PVFFL to make it to the playoffs every year since 2022, winning the North league championship last year.
...
| ------------------------------------- | --------- | --------------------- |
| [[Site/Teams/@CommissionerSmore (Bijan Kenobi)\|@CommissionerSmore (Bijan Kenobi)]] | A         | QB                    |
| [[Site/Teams/@cardkid2331 (It's Gonna Be Maye)\|@cardkid2331 (It's Gonna Be Maye)]] | A-        | TE                    |
| [[Site/Teams/@Kathy8 (AJ's Book Club)\|@Kathy8 (AJ's Book Club)]]          | B+        | TE, (Bench) RB        |
## PVFFL South
...
The next round (4) was the TE round, where 6 TEs were drafted. In rounds 4 and 5, all but one team ([[Site/Teams/@trustyen (Miles pickens)\|@trustyen (Miles pickens)]]) drafted a TE. Kickers followed a similar pattern, with all but three teams picking up a kicker within rounds 9-11.
...
| [[Site/Teams/@cpence0712 (To Infinity and Bijan!)\|@cpence0712 (To Infinity and Bijan!)]] | B         | WR, TE                |
